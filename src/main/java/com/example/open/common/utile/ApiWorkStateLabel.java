...
public class ApiWorkStateLabel {
    ...
    public static final String WORKING_TEXT = "작업중";
    public static final String OK_TEXT = "작업완료";
    public static final String UPDATE_TEXT = "업데이트";
    public static final String NOT_WORKING_TEXT = "작업안함";
    public static final String TEST_TEXT = "테스트중";
    public static final String TEST_COMPLETE_TEXT = "테스트완료";
    public static final String TEST_FAIL_TEXT = "테스트실패";
    public static final String TEST_SUCCESS_TEXT = "테스트성공";
